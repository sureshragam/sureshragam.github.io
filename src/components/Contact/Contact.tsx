...
const Contact = () => {
  ...
  const validateForm = () => {
    const newErrors: { name: any; email: any; message: any } = {
      name: "",
      email: "",
      message: "",
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(
        "Error submitting form, Please try again later or contact me directly using the email provided"
      );
      setAlertType("error");
      setOpen(true);
      setFormData({
      ...
      <div style={{ display: "flex" }}>
        ...
        <div className={classes.col2}>
          ...
          >
            <input
              type="text"
              placeholder={staticData?.namelabel}
              name={staticData?.namelabel?.toLowerCase()}
            ...
            <input
              type="mail"
              placeholder={staticData?.emaillabel}
              name={staticData?.emaillabel?.toLowerCase()}
              className={classes.inputField}
              onChange={handleChange}
            ...
            />
            <textarea
              placeholder={staticData?.messagelabel}
              name={staticData?.messagelabel?.toLowerCase()}
