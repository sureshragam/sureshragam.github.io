...
export const scrollSkillsData = [
	...
	new ObjectGenerator({ name: "Spring Boot", icon: "SiSpringboot" }),
	new ObjectGenerator({ name: "sql", icon: "SiSqlite" }),
	new ObjectGenerator({ name: "GIT", icon: "FaGit" }),
	new ObjectGenerator({ name: "Github", icon: "FaGithub" }),
];
...
export const fallBackData = {
		...
		projects: [
			{
				name: "Ugaoo",
				description:
					"Ugaoo is an online plant nursery that sells a variety of plants, gardening supplies, and accessories:",
				url: "https://sureshragam.github.io/ugaoo-clone/",
			},
			{
				name: "Food Munch",
				description:
					"Static website focusing on responsiveness, showcasing various menu of a restaurant.",
	...
	externalLinks: [
		{
			name: "LinkedIn",
			url: "https://www.linkedin.com/in/suresh-ragam/",
		},
		{
			name: "Github",
			url: "https://github.com/sureshragam",
		},
		{
			name: "contactform",
			url: "https://zep1f7tlgb.execute-api.ap-south-1.amazonaws.com/contact",
		},
	],
	skills: scrollSkillsData,
};
